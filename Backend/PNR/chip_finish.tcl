...
saveNetlist ${top_cell}.v 

# Generate Post-PNR Gate Level Netlist with PG Pins
saveNetlist ${top_cell}_pg.v -includePowerGround

# Generate SDF File
delayCal -sdf ${top_cell}.sdf -version 3.0
...
# Generate GDS File
streamOut ${top_cell}.gds -mapFile gds2InLayer.map -libName DesignLib -stripes 1 -units 2000 -mode ALL
